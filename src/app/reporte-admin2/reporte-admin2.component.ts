...
import { ReportesActivosService } from '../reportes-activos/services/reportes-activos.service';
import { HttpClient, HttpHeaders } from '@angular/common/http';

@Component({
  selector: 'app-reporte-admin2',
  templateUrl: './reporte-admin2.component.html',
